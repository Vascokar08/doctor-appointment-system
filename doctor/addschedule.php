...
<body>
    <div id="wrapper">
                                        ...
                                        <form class="form-horizontal" method="post">
                                            ...
                                            <div class="form-group">
                                                <div class="col-sm-10 col-sm-offset-2">
                                                    <button onclick="btn btn-primary " name="submit" type="submit">
                                                        Submit
                                                    </button>
                                                </div>
                                            </div>
        ...
        <div class="datepicker datepicker-dropdown dropdown-menu datepicker-orient-left datepicker-orient-top" style="top: 46px; left: 162.863px; display: block;">
            <!-- ... Calendar content ... -->

            <script>
                const dayCells = document.querySelectorAll('.day'); // Get all elements with the class "day"

                dayCells.forEach(cell => {
                    const cellContent = cell.textContent.trim(); // Get the content of the cell
                    if (cellContent === 'Su') { // Check if the content is 'Su' (Sunday)
                        cell.classList.add('sunday'); // Apply the 'sunday' class to hide the Sunday cell
                    }
                });
            </script>
            ...
            <script src="assets/js/jquery-dateformatter.js"></script>
            ...
            <script>
                $(document).ready(function() {
                    var disabledDays = ["2023-08-15", "2023-08-29"];
                ...
                $('#starttime, #endtime').clockpicker({
                    ...
                    afterShow: function() { // Disable all hours out of range
                        ...
                        $(".clockpicker-hours").find(".clockpicker-tick").filter(function(index, element) {
                            hour = parseInt($(element).html());
                            if (hour == 13 || hour == 14 || hour == 00)
                                return hour;
                    ...
                    afterHourSelect: function() {
                        hourSelected = document.getElementById('starttime').val();
